...
library("poLCA")
# Read the dataset
dataset_readed<- read.csv(file="semeion.data", sep=" ", stringsAsFactors=FALSE)
#Print the dataset
```
...
```{r}
 colnames(dataset_readed)<- c("G1","G2","G3","G4","G5","G6","G7","G8","G9","G10","G11","G12","G13","G14","G15","G16","G17","G18","G19","G20"
...
```{r}
f  <- with(newX, 
           cbind(G1,G2,G3,G4,G5,G6,G7,G8,G9,G10,G11,G12,G13,G14,G15,G16,G17,G18,G19,G20
                ,G21,G22,G23,G24,G25,G26,G27,G28,G29,G30,G31,G32,G33,G34,G35,G36,G37,G38,G39,G40
                ,G41,G42,G43,G44,G45,G46,G47,G48,G49,G50,G51,G52,G53,G54,G55,G56,G57,G58,G59,G60
                ,G61,G62,G63,G64,G65,G66,G67,G68,G69,G70,G71,G72,G73,G74,G75,G76,G77,G78,G79,G80
                ,G81,G82,G83,G84,G85,G86,G87,G88,G89,G90,G91,G92,G93,G94,G95,G96,G97,G98,G99,G100
                ...
                ,G201,G202,G203,G204,G205,G206,G207,G208,G209,G210,G211,G212,G213,G214,G215,G216,G217,G218,G219,G220
                ,G221,G222,G223,G224,G225,G226,G227,G228,G229,G230,G231,G232,G233,G234,G235,G236,G237,G238,G239,G240
                ,G241,G242,G243,G244,G245,G246,G247,G248,G249,G250,G251,G252,G253,G254,G255,G256)~1)
```

```{r}

Finalresults <- setNames(data.frame(matrix(ncol = 3, nrow = 0)), c("Model", "BIC" ," Rand Index"))

for (k in 5:15) {
  lcaResult <- poLCA(f, newX, nclass=k, maxiter=3000, tol=1e-10, probs.start=NULL, nrep=3, verbose=TRUE, calc.se=TRUE)
  lcaResult
